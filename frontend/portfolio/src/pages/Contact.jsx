    ...
    >
      ...
      <div className="max-w-lg mx-auto space-y-4 transition duration-300 hover:-translate-y-1">
        ...
        <Card
          ...
          title="Email"
          value={contactData?.email || "Not Added"}
          link={contactData?.email ? `mailto:${contactData.email}` : null}
        />
        <Card
          icon={<Linkedin size={18} />}
          title="LinkedIn"
          value={contactData?.linkedin || "Not Added"}
          link={contactData?.linkedin || null}
        />
        <Card
          icon={<Github size={18} />}
          title="GitHub"
          value={contactData?.github || "Not Added"}
          link={contactData?.github || null}
        />
        <Card
          icon={<MapPin size={18} />}
          title="Location"
