...
//   // FIX: Add state to hold the specific certificate being viewed in the modal
...
//               Cancel
//             </button>
//             <button type="submit" className="bg-cyan-500 px-3 py-1 rounded">
//               Save
//             </button>
//           </div>
//         </form>
...
//                   <button
//                     onClick={() => {
//                       setSelectedCert(cert); // Set the cert data
//                       setShowImage(true); 
//                       window.open(cert.image, "_blank"); // Open the image in a new tab
//                     }}
...
//       {/* IMAGE MODAL */}
//       {showImage && selectedCert && (
//         <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 px-4">
//           <div className="relative max-w-3xl w-full">
//             <img
//               src={selectedCert.image} // FIX: Use the state variable here
//               alt="certificate"
...
//               }}
//               className="absolute top-3 right-3 bg-red-600 px-3 py-1 rounded text-white font-bold"
//             >
//               X
//             </button>
//           </div>
...
export default function Certifications() {
      ...
      {showForm && (
        ...
        >
          ...
          <div className="flex justify-end gap-3">
            ...
            <button type="submit" className="bg-cyan-500 px-4 py-1 rounded text-black font-medium">
              Save
            </button>
          </div>
        </form>
            ...
            >
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                ...
                <div className="flex gap-2 flex-wrap">
                  {/* <button
                    onClick={() => {
                      // UPDATED: Opens the Cloudinary URL (PDF or Image) in a new tab
                      if (cert.image) {
  ...
  onClick={() => {
    if (cert.image) {
      // PDF ke liye hum direct link open karenge
      // Agar URL ke bich mein "/image/upload" hai aur wo load nahi ho raha, 
      // toh ho sakta hai ki wo actually "/raw/upload" hona chahiye.
      const fileUrl = cert.image.replace("/image/upload/", "/raw/upload/");
